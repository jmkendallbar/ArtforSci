...
with open('C:/Users/Jessie/Pictures/Art/Will Gough Bubble Net Feeding/Data_Example_PositionRotationData.csv') as csv_file:
    ...
    for i, row in enumerate(data, 1):
        if i % 10000 == 0:
            ...
            #We will use the function float() to return floating point numbers (with decimals) for data values
                ...
                object = pm.ls('humpback_rigg_0039RN')[0] 
