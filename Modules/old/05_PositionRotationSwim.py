...
START = 60763  #start time in sec
END = 63846   #end time in sec

fs = 10 #Sample frequency (in Hz or "samples per second")

#Reading in .csv file (update to reflect your own path)
with open('C:/Users/fbar/Documents/Visualization/Data/test33_HypoactiveHeidi_05_ALL_PROCESSED_Trimmed.csv') as csv_file:
